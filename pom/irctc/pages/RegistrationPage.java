...
public class RegistrationPage extends GenericWrappers{
	...
	public RegistrationPage waitsec(int time) {
		waitProperty(time);
		return this;
	}
	...
	public RegistrationPage clickOnLanguage(String value) {
		clickByXpath(prop.getProperty("RegistrationPage.Language.XPath"),value);
	...
	public RegistrationPage clickOnSecQuestionOption(String value) {
		clickByXpath(prop.getProperty("RegistrationPage.SecurityQuestion.XPath"),value);
	...
	public RegistrationPage ClickOnOccupationOption(String value) {
		clickByXpath(prop.getProperty("RegistrationPage.Occupation.XPath"),value);
	...
	public RegistrationPage selectDate(String value) {
		clickByXpath(prop.getProperty("RegistrationPage.Date.XPath"),value);
		//clickByXpath("//a[text()='"+date+"']");
		return this;
	}
	
	public RegistrationPage clickOnMarriageStatus(String value) {
		clickByXpath(prop.getProperty("RegistrationPage.MarriageStatus.XPath"),value);
	...
	public RegistrationPage clickOnGender(String value) {
		clickByXpath(prop.getProperty("RegistrationPage.Gender.XPath"),value);
	...
	public RegistrationPage clickCopyResAddrressToOffice(String value) {
		clickByXpath(prop.getProperty("RegistrationPage.ResidentOfficeAddress.XPath"),value);
		//clickByXpath("//label[text()='"+value+"']");
		return this;
	}
	...
	public RegistrationPage clickOnOffCountryDropdown() {
	 ...
	 public RegistrationPage clickOnOffCountryoption(String value) {
		 clickByXpath(prop.getProperty("RegistrationPage.OfficeCountry.XPath"),value);
		 //clickByXpath("//span[text()='"+option+"']/parent::*");
		 return this;
	 }
