...
public class FTRUserRegistrationPage extends GenericWrappers{
	...
	public FTRUserRegistrationPage clickOnDObDate(String value) {
		clickByXpath(prop.getProperty("FTRUserRegistrationPage.DobDate.XPath"),value);
		//clickByXpath("//a[text()='"+date+"']/parent::*");
		return this;
	}
	
	public FTRUserRegistrationPage clickOnGender(String value) {
		clickByXpath(prop.getProperty("FTRUserRegistrationPage.Gender.XPath"),value);
		//clickByXpath("//input[@name='gender'and@value='"+value+"']");
		return this;
	}
	
	public FTRUserRegistrationPage clickOnMarriageStatus(String value) {
		clickByXpath(prop.getProperty("FTRUserRegistrationPage.MarriageStatus.XPath"),value);
	...
	public FTRUserRegistrationPage clickOnSameAsResAddress(String value) {
		clickByXpath(prop.getProperty("FTRUserRegistrationPage.ResidentOfficeAddress.XPath"),value);
