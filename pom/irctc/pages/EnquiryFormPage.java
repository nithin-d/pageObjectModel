...
public class EnquiryFormPage extends GenericWrappers{
	...
	public EnquiryFormPage clickOnDepartureDate(String value) {
		clickByXpath(prop.getProperty("EnquiryFormPage.DepartureDate.XPath"),value);
	...
	public EnquiryFormPage clickOnArrivalDate(String value) {
		clickByXpath(prop.getProperty("EnquiryFormPage.ArrivalDate.XPath"),value);
